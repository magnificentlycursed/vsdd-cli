...
DR findings route to Technical Writer (validator pair) — DR cold-reads, TW co-authors. Cluster-batching invariant: DR ↔ TW on different agents in Phase 3 sessions.
