...
2. **Methodology-spirit adherence.** Does cycle discipline-application match the methodology's spirit? Catches cycles that follow the letter of the methodology (right hook count, right phase sequencing) but violate the spirit (sycophantic reviews, performative pre-cycle declarations, cluster-batching abused as cost-cutting).
