...
```yaml
phase: phase-2b
composed_domains: [software-engineer, quality-engineer, technical-writer, documentation-reviewer, platform-engineer, ...configuration-activated]
...
Record the phase transition (`PhaseExited{phase: phase-2b, exit_status: complete, layer: <N>}`) in the crosslink session breadcrumb and the trace at the closing commit. Opens Phase 2c.
