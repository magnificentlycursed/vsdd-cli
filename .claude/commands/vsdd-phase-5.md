...
phase: phase-5
version: 0.1.0
frequency: per milestone (optional — declared in DESIGN.md § Project intent `Phase 5 strategy:`)
...
**Four surfaces** (each independent — a milestone may exercise all, some, or one per project intent):
...
- [Phase 3 primer](./vsdd-phase-3.md) — Phase 5 sits AFTER Phase 3 implementation-MVR for the milestone
