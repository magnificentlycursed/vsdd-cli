...
| 5 | check-anonymization | Pre-commit on all committed text files | $HOME / git user.name / git user.email / API-key formats (`sk-ant-api03-`, `Bearer <token>`, etc.) | VSDD-E0110 (credential-shaped-value-detected-in-committed-text) | Both |
