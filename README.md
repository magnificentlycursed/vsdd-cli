...
**Documentation narrative-preservation (prose discipline).** Authoring discipline for the methodology spec + primers + domain prompts + supplements. Pre-rebuild artifacts in the existing suite stay as authored per the original semantics. Within the toolkit's own history, narrative-preservation applies forward-only from the toolkit's first commit.
...
- The existing suite's forward-only narrative-preservation discipline continues to apply to its own history. The rebuild's documentation-narrative-preservation discipline applies to the toolkit's own history.
