...
entries:
  ...
  - {act: run-monitoring, affordance: "crosslink kickoff list / check surface / mission control", kind: chassis-workflow, condition: "kickoff status covers pipeline-sidecar runs only (dollspace-gay/crosslink#18); list is the all-modes surface"}
