...
calibration_bands:
  ...
  - {operation: cold-code-review-round, band: "5 to 30 findings pre-dedup, 4 to 15 minutes wall-clock, 120,000 to 300,000 downstream tokens per four-lens round", provenance: "seeded from the Layer 1 code round's first actuals — 26 findings pre-dedup, ~4.7 minutes, 187,308 downstream tokens, four lenses at mixed per-lens dials; capture source workflow task telemetry (vsdd-cli #720, 2026-07-21); the unseeded 2-to-10 guess is retired, corrected the same way the spec band's was"}
presets:
  - id: thorough
  ...
  - id: standard
    active_domains: "the six core role domains — software-engineer, security, ux, quality-engineer, solution-owner, solution-architect — plus sanity-check (membership and count are the tier-marked core prompts on disk, verifiable against the installed prompts; enumerated inline per vsdd-cli #710)"
    round_budget: 5
